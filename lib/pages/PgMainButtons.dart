...
class PgMainButtons extends StatelessWidget {
  ...
  static const List<Map<String, dynamic>> pageList = [
    ...
    {'icon': Icons.add, 'title': 'Alteração de Projeto', 'page': ''},
    {'icon': Icons.content_paste, 'title': 'Visita Técnica', 'page': '/visita-tecnica'},
    {'icon': Icons.add, 'title': 'Aumento de Sistema', 'page': ''},
    {'icon': Icons.add, 'title': 'Entrega de Obra', 'page': ''},
    {'icon': Icons.add, 'title': 'Solicitação de Serviços', 'page': ''},
